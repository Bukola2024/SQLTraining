...
REASONDESCRIPTION varchar(500) null
 ...
 from 'C:\Users\bukky\Documents\ETL Training\Hospital Project\careplans.csv'
with
...
[REACTION1] varchar (200) null,[dbo].[Allergies]
...
--bulk insert
 ...
 from 'C:\Users\bukky\Documents\ETL Training\Hospital Project\Allergies.csv'
with
(format='csv', firstrow = 2,
fieldterminator=',',
rowterminator='0x0a'
...
--bulk insert
 bulk insert Claims
 from 'C:\Users\bukky\Documents\ETL Training\Hospital Project\Claims.csv'
with
(format='csv', firstrow = 2,
fieldterminator=',',
rowterminator='0x0a'
...
--bulk insert
 ...
 from 'C:\Users\bukky\Documents\ETL Training\Hospital Project\Claims_transactions.csv'
with
(format='csv', firstrow = 2,
fieldterminator=',',
rowterminator='0x0a'
...
bulk insert Conditions
 from 'C:\Users\bukky\Documents\ETL Training\Hospital Project\Conditions.csv'
with
(format='csv', firstrow = 2,
fieldterminator=',',
rowterminator='0x0a'
...
--bulk insert
bulk insert Devices
 from 'C:\Users\bukky\Documents\ETL Training\Hospital Project\Devices.csv'
with
(format='csv', firstrow = 2,
fieldterminator=',',
rowterminator='0x0a'
...
bulk insert Medications
 from 'C:\Users\bukky\Documents\ETL Training\Hospital Project\Medications.csv'
with
(format='csv', firstrow = 2,
fieldterminator=',',
rowterminator='0x0a'
...
bulk insert Observations
 from 'C:\Users\bukky\Documents\ETL Training\Hospital Project\Observations.csv'
with
(format='csv', firstrow = 2,
fieldterminator=',',
rowterminator='0x0a'
