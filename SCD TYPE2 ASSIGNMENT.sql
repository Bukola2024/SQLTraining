Create Database EmadeconsultingDev
Use EmadeconsultingDev
...
INSERT INTO TGT_EMADEPRODUCTLIST (PRODUCTID, PRODUCTNAME, PRICE, STARTDATE, ENDDATE, IS_ACTIVE)
VALUES
    (101, 'TEA', 10.00, '2024-01-01', '2024-12-13', 'Y'),
    (102, 'COFFEE', 15.00, '2024-01-01', '2024-12-13', 'Y'),
    (103, 'BISCUITS', 20.00, '2024-01-01', '2024-12-13', 'Y');


--PERFORMING MERGE OPERATIONS
INSERT INTO TGT_EMADEPRODUCTLIST  (PRODUCTID,PRODUCTNAME, PRICE)
SELECT PRODUCTID,PRODUCTNAME, PRICE 
FROM (
    MERGE INTO TGT_EMADEPRODUCTLIST  AS TARGET
    USING TGT_EMADEPRODUCTLIST  AS SOURCE
